      ...
      <Card className="p-6 bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            {resident && <p className="text-muted-foreground">House {resident.house_no} • Lane {resident.lane_no}</p>}
          </div>
        </div>
        ...
        {editing ? (
          <div className="grid gap-4">
            ...
            <div className="flex gap-2">
              <Button onClick={handleSave} className="gradient-warm text-primary-foreground"><Save className="h-4 w-4 mr-2" />Save</Button>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-3 rounded-lg bg-card border">
                ...
                <div>
                  ...
                  <p className="font-medium">{form.mobile || 'Not set'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg bg-card border">
                ...
                <div>
                  ...
                  <p className="font-medium text-sm">{form.email || 'Not set'}</p>
                </div>
              </div>
              {resident && (
                <>
